    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{ url('/') }}"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">Beehive</h2>
                    </a>
                </li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="navigation-header"><span data-i18n="Apps &amp; Pages">Admin Tool</span><i data-feather="more-horizontal"></i>
                </li>
                <li class="nav-item has-sub"><a class="d-flex align-items-center" href=""><i data-feather='pocket'></i></i><span class="menu-title text-truncate" data-i18n="Email">Home Page</span></a>
                ...
                <li class="nav-item has-sub"><a class="d-flex align-items-center" href=""><i data-feather='pocket'></i></i><span class="menu-title text-truncate" data-i18n="Email">Listings</span></a>
                    <ul class="menu-content">
                        <li style="margin-left: 45px !important;" class="">
                            <a class="d-flex align-items-center" href=""><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                        </li>
                        <li style="margin-left: 45px !important;" class="">
                            <a class="d-flex align-items-center" href=""><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate" data-i18n="List">Create</span></a>
                        </li>
                ...
                <li class="nav-item has-sub"><a class="d-flex align-items-center @yield('portfolios_edit')" href=""><i data-feather='pocket'></i></i><span class="menu-title text-truncate" data-i18n="Email">Projects</span></a>
                    <ul class="menu-content">
                        <li style="margin-left: 45px !important;" class=" @yield('portfolios_show')">
                        ...
                        <li style="margin-left: 45px !important;" class=" @yield('portfolios_create')">
