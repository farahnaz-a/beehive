...
@section('title')
    {{ config('app.name') }} | Account Statistics
@endsection
...
@section('js')
    ...
    <script src="{{ asset('dashboard_assets/app-assets/vendors/js/charts/chart.min.js') }}"></script>
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('dashboard_assets/app-assets/js/scripts/charts/chart-chartjs.js') }}"></script>
