...
<!--  Last Published: Tue Aug 10 2021 16:00:08 GMT+0000 (Coordinated Universal Time)  -->
...
<head>
  ...
  <link href="{{ asset('new_user_dashboard_assets/images/favicon.png') }}" rel="shortcut icon" type="image/x-icon">
  <link href="{{ asset('new_user_dashboard_assets/images/webclip.png') }}" rel="apple-touch-icon">
...
<body class="body-14">
          ...
          <div class="navigation-right headerco">
            ...
            <div data-hover="" data-delay="0" class="dropdown-40 w-dropdown">
              ...
              <nav class="dropdown-list-16 w-dropdown-list">
                ...
                <a href="#" class="link-block-27 w-inline-block"><img src="images/log-out.svg" loading="lazy" alt="" class="image-151">
      ...
      <div class="div-block-6546">
        ...
        <div class="w-layout-grid _2-1-grid">
          <div class="module-2">
            ...
            </div><img src="https://uploads-ssl.webflow.com/plugins/Basic/assets/placeholder.60f9b1840c.svg" loading="lazy" alt="" class="image-189">
          </div>
        ...
        <div class="card_ghost_shadow">
          <div class="div-block-592">
            <div class="div-block-641">
              <h4 class="heading-217">Projets</h4>
  ...
  <div class="nav-bottom">
    <div class="w-layout-grid grid-55">
      <a href="{{ url('/customer/account') }}" aria-current="page" class="w-inline-block w--current"><img src="images/60dca32b27ab1dae5648da31_bar-chart-2.svg') }}" loading="lazy" alt="not-found"></a>
      <a href="make-a-deposit.html" class="w-inline-block"><img src="{{ asset('new_user_dashboard_assets/images/dollar-sign.svg" loading="lazy') }}" alt=""></a>

      <a href="#" class="w-inline-block"><img src="{{ asset('new_user_dashboard_assets/images/60dca32b27ab1db1b948d78e_search.svg') }}" loading="lazy" width="30" alt="not-found"></a>
      <a href="#" class="w-inline-block"><img src="{{ asset('new_user_dashboard_assets/images/60dca32b27ab1d092448da94_heart.svg') }}" loading="lazy" alt="not-found"></a>
      <a href="#" class="w-inline-block"><img src="{{ asset('new_user_dashboard_assets/images/60dca32b27ab1d93c348da3b_bell.svg') }}" loading="lazy" alt="not-found"></a>
    </div>
  </div>
    ...
    <div class="container-37">
      <div class="footer-menu-wrapper">
        <div class="footer-menus">
          ...
          <div class="div-block-6463">
            <div data-delay="0" class="footer-dropdown w-dropdown">
              <div class="footer-dropdown-toggle w-dropdown-toggle">
                <div class="text-block-543">FR</div>
                <div class="footer-dropdown-icon w-icon-dropdown-toggle"></div>
              </div>
              <nav class="dropdown-list-20 w-dropdown-list">
                <a href="#" class="w-dropdown-link">EN</a>
                <a href="#" class="w-dropdown-link">FR</a>
                <a href="#" class="w-dropdown-link">SP</a>
              </nav>
            </div>
          </div>
          <div data-delay="0" class="footer-dropdown w-dropdown">
            <div class="footer-dropdown-toggle w-dropdown-toggle">
              <div class="text-block-544">€</div>
              <div class="footer-dropdown-icon w-icon-dropdown-toggle"></div>
            </div>
            <nav class="dropdown-list-20 w-dropdown-list">
