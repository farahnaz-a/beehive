...
<body class="body-14">
  ...
  <div class="nav-bottom">
    <div class="w-layout-grid grid-55">
      <a href="dashboard.html" aria-current="page" class="w-inline-block w--current"><img src="images/60dca32b27ab1dae5648da31_bar-chart-2.svg') }}" loading="lazy" alt="not-found"></a>
