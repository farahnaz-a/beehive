    ...
    <div class="container">
      <div class="form-wrapper">
        <div class="form-base">
          ...
          <div class="step-register">Etape 2/3</div>
          <div class="w-form">
            <form  action="{{ route('customer.information') }}" data-name="Register Form" method="POST">
              ...
              <div class="div-block-6348">
                <a href="{{ route('customer.information') }}" onclick="event.preventDefault();this.closest('form').submit();" class="button w-button">Continuer</a>
              </div>
            </form>
